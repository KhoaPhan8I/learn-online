...
<meta name="description" content="Bảng giá Learn Online: đăng lớp miễn phí vĩnh viễn. Ghim Nổi Bật 29.000đ/7 ngày: kệ Nổi Bật + badge + đứng đầu tìm kiếm.">
<link rel="canonical" href="{url}">
<meta property="og:type" content="article">
<meta property="og:url" content="{url}">
<meta property="og:image" content="{site}/og-cover.png">
<script type="application/ld+json">
{{"@context":"https://schema.org","@type":"Product","name":"Ghim Nổi Bật — Learn Online","description":"Ghim lớp lên kệ Nổi Bật 7 ngày kèm badge. Thanh toán chuyển khoản, admin duyệt trong 24h, không duyệt hoàn tiền.","offers":{{"@type":"Offer","price":"29000","priceCurrency":"VND","availability":"https://schema.org/InStock","url":"{url}"}}}}
</script>
</head>
<body>
